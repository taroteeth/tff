...
class animations {
  constructor() {
    this.eleArr = [];
    this.elements = document.querySelectorAll('.trigger_fade, .trigger_tile, .trigger_circle_grow, .grayscale, .trigger_bubble_grow, .trigger_img_slide_left, .trigger_img_slide_right, .hero-title');
    this.interval;
    this.currentScroll;
